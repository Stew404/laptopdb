...
export default function Element({
    ...
    return (
        <div className="flex justify-between items-center w-full h-[7rem] px-[1.6rem] rounded-[2.4rem] block-bg main-border main-shadow hover:translate-y-[-1px] transition-transform">
            <a
            ...
            <button
                ...
                className="button text-red-700 p-[.8rem] rounded-[1.6rem]"
            >
                Удалить
            </button>
        </div>
